...
store.subscribe(() => { console.log(store.getState()) }); // pasamos definicion de funcion

// store.subscribe(() => renderContador());
store.subscribe(renderContador); // pasamos como argumento la definicion de la funcion renderContador
